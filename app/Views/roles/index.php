                                    ...
                                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-2">
                                                <a href="/PIZZA4/public/roles/edit/<?php echo $rol['id']; ?>" class="text-blue-500 hover:text-blue-700 transition-colors duration-300">Editar</a>
                                                <span>|</span>
                                                <a href="/PIZZA4/public/roles/delete/<?php echo $rol['id']; ?>" class="text-red-500 hover:text-red-700 transition-colors duration-300" onclick="return confirm('¿Estás seguro de eliminar este rol?');">Eliminar</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
