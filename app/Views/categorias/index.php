            ...
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                    ...
                    <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                        ...
                        <a href="/PIZZA4/public/categorias/create" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 dark:bg-yellow-400 dark:hover:bg-yellow-500 focus:outline-none dark:focus:ring-yellow-800">
                                ...
                                <?php foreach ($data['categorias'] as $categoria) : ?>
                                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <a href="/PIZZA4/public/categorias/edit/<?php echo $categoria['id']; ?>" class="Btn edit-btn">
                                                        Editar
                                                    ...
                                                    <a href="/PIZZA4/public/categorias/delete/<?php echo $categoria['id']; ?>" class="Btn delete-btn" onclick="return confirm('¿Estás seguro de eliminar este categoria?');">
                                                        Borrar
