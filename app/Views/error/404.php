...
<main class="h-full pb-16 overflow-y-auto h-screen bg-gray-50 dark:bg-gray-900">
    <div class="container flex flex-col items-center px-6 mx-auto">
        ...
        <p class="text-gray-700 dark:text-gray-300">
            Página no encontrada. Verifique la dirección o
            <a class="text-purple-600 hover:underline dark:text-purple-300" href="<?php echo APP_URL ?>">
                regrese
            </a>
            .
        </p>
