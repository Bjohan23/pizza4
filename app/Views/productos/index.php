                                    ...
                                    <?php foreach ($data['productos'] as $producto) : ?>
                                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-4 py-3">
                                                ...
                                                <a href="/PIZZA4/public/roles/edit/<?php echo $producto['id']; ?>" class="Btn edit-btn">
                                                        Editar
                                                    ...
                                                    <a href="/PIZZA4/public/roles/delete/<?php echo $producto['id']; ?>" class="Btn delete-btn" onclick="return confirm('¿Estás seguro de eliminar este producto?');">
                                                        Borrar
