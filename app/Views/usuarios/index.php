                   ...
                   <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                       <div class="flex items-center flex-1 space-x-4">
                           <h5>
                               ...
                               <span class="dark:text-white"><?php echo count($data['usuarios']); ?></span>
                           </h5>
                       </div>
                       <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                           <a href="<?= USER_CREATE ?>" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                                       ...
                                       <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                           ...
                                           <td class="px-4 py-3">
                                               <div class="flex items-center space-x-2">
                                                   <a href="<?= USER_EDIT?><?php echo $usuario['id']; ?>" class="Btn edit-btn">
                                                       Editar
                                                   ...
                                                   <span>|</span>
                                                   <a href="<?= USER_DELETE ?><?php echo $usuario['id']; ?>" class="Btn delete-btn">
                                                       Borrar
