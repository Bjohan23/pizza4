                ...
                <div class="px-4 py-3">
                    ...
                    <?php if (isset($data['pedido'])) : ?>
                            ...
                            <table class="min-w-full bg-white border dark:bg-gray-800">
                                <thead class="bg-gray-200 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th colspan="1" class="py-2 px-4 border dark:border-gray-600 dark:text-white">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                        ...
                        <form id="cobrar-form" class="mt-4">
                            ...
                            <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="window.location.href='/PIZZA4/public/pedidos/create/<?php echo htmlspecialchars($data['mesa_id']); ?>'">Agregar Nuevo Producto</a>
                        </form>
    ...
    switch (this.value) {
        case 'efectivo':
            ...
            document.getElementById('payment-amount').addEventListener('input', function() {
                ...
                document.getElementById('change-amount').value = changeAmount >= 0 ? changeAmount : 0;
            });
            break;
        case 'tarjeta':
            paymentFields.innerHTML = `
...
document.getElementById('paymentForm').addEventListener('submit', function(event) {
    ...
    if (paymentMethod === 'efectivo') {
        ...
        if (paymentAmount < totalAmount) {
            alert('La cantidad con la que paga no puede ser menor al monto total.');
            return;
        }

        alert(`Pago realizado con éxito. El vuelto es: ${changeAmount}`);
