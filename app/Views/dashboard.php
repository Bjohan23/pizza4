...
<div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="#" class="flex items-center justify-between mr-4">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PIZERIA</span>
                </a>
    ...
    <main class="p-4 md:ml-64 h-auto pt-20">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <!-- Clientes -->
            <div class="border-2 border-gray-300 rounded-lg dark:border-gray-600 h-32 md:h-64 flex items-center p-4">
                <div class="flex items-center w-full">
                    <span class="text-4xl mr-4">👥</span>
                    <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div class="bg-zinc-800 p-4 rounded">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm">mesas ocupadas</p>
