                                   ...
                                   <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                       ...
                                       <td class="px-4 py-3">
                                           <div class="flex items-center space-x-2">
                                               <a href="<?php echo TABLE_EDIT ?><?php echo $mesa['id']; ?>" class="Btn edit-btn">
                                                   Editar
                                               ...
                                               <a href="<?php echo TABLE_DELETE ?><?php echo $mesa['id']; ?>" class="Btn delete-btn" onclick="return confirm('¿Estás seguro de eliminar este mesa?');">
                                                   Borrar
