    ...
    <div class="border-2 rounded-lg border-gray-300 dark:border-gray-600 p-4">
        ...
        <form action="/PIZZA4/public/mesas/edit/<?php echo $data['mesa']['id']; ?>" method="post">
            <div class="mb-4">
                ...
                <input type="text" id="numero" name="numero" value="<?php echo $data['mesa']['numero']; ?>" required class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
            <div class="mb-4">
                <label for="capacidad" class="block text-sm font-medium text-gray-700">Capacidad:</label>
                <input type="text" id="capacidad" name="capacidad" value="<?php echo $data['mesa']['capacidad']; ?>" required class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
            <div class="mb-4">
