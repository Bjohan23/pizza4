        ...
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form action="<?php echo CLIENT_CREATE ?>" method="post" class="space-y-8">
                ...
                <div>
                    ...
                    <input type="text" id="telefono" name="telefono" pattern="\d{9}" title="El número de teléfono debe tener exactamente 9 dígitos" required class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light">
                </div>
                <div>
